...
StartGameButton::StartGameButton(Vec3d position, Vec4d color)
{
	enabled = true;

	titleText = DEFAULT_GAME_TEXT;
...
StartGameButton::StartGameButton(void)
{
}
...
int StartGameButton::onClick(int currentState) {
		return GAME_S;
}